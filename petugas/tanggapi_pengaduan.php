...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <form method="post" action="proses_tanggapi.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="" style="font-size: 14px;">Isi Tanggapan</label>
                <textarea name="isi_tanggapan" id="isi_tanggapan" class="form-control" placeholder="Isi Tanggapan"
                    required></textarea>
                <br>
            <div class="form-group">
